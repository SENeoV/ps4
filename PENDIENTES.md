...
- [ ] 🎮 Medida que lo zanjaría, cuando la consola vuelva a Linux: `EmulationSpeed = 0` (sin límite) y leer los fps en la playa; y `Overclock = 2.0` sin los códigos, para medir el coste de duplicar el reloj emulado
