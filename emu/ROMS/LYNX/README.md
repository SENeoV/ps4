# LYNX — Atari Lynx (1989)

- **Estado:** Tanda 1 — sin BIOS, debería ir al 100%
- **Cores instalados en la PS4:** `handy` (recomendado), `mednafen_lynx`
- **Extensiones:** `.lnx`
- **BIOS** (en `/data/retroarch/system/`, salvo que se indique otra cosa):
  - `lynxboot.img` — opcional en `handy`, obligatoria en `mednafen_lynx`

**Notas:** Empezar con `handy`, que no la exige.
