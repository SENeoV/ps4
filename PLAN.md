...
├── ORIGINALES/<SISTEMA>/ <- zip original de lo que va descomprimido (DOS); se cataloga, no se sube
...
- **C64:** Ghostware más lo que solo traía el pack de Google Drive, con 509 `.m3u` para los juegos de varios discos, y la mejor versión de cada `.prg` TOSEC.
...
- [x] 🎮 **Pack de texturas HD completo (9,2 GB, 5.747 archivos) en la consola y a 29,97 fps** (15-09). *Wind Waker* con el aspecto del remaster de Wii U, a velocidad completa
